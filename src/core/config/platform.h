#ifndef NET_DISPATCHER_PLATFORM_H
#define NET_DISPATCHER_PLATFORM_H

#include "compiler.h"

#ifdef USE_MAC_QT
#define FORCE_USE_QT 1
#else
#define FORCE_USE_QT 0
#endif
...
#define USE_WEB_THREAD 0

#if !PLATFORM(WATCHOS) && !PLATFORM(APPLETV)
#define USE_QUICK_LOOK 0
#endif

#if TARGET_OS_IOS
#define HAVE_APP_LINKS 0
#endif
...
#if USE(GLIB)
#include "glib/GTypedefs.h"
#endif

#if PLATFORM(EFL)
#include "efl/EflTypedefs.h"
#endif
...
#define USE_COREMEDIA 0
#define HAVE_AVFOUNDATION_VIDEO_OUTPUT 0
#endif
...
#define USE_WINDOWS_EVENT_LOOP 0
